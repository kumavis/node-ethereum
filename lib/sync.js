...
var sync = module.exports = function (peer) {
  ...
  // var hash = new Buffer('622b2e17dac6c5122fd353c7f40a5e7f277869208975b55b92cf086b8eb31ce7','hex');
  // var self = this;
  // peer.getBlocks([hash], function(blocks){
  //   processBlocks.bind(self)(blocks);
  // });
};
