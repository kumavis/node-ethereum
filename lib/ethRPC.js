...
EthRPC.prototype.eth_call = function(params, cb) {
  ...
  this.getBlock(params[1], function(err, stateTrie){
    ...
    var transaction = new Transaction({
      to: normalizeHexString(params[0].to),
      from: normalizeHexString(params[0].from),
      gas: normalizeHexString(params[0].gas),
      gasPrice: normalizeHexString(params[0].gasPrice),
      value: normalizeHexString(params[0].value),
      data: normalizeHexString(params[0].data)
    });
...
EthRPC.prototype.eth_blockNumber = function(params, cb){
  cb(null, this.app.blockchain.head.header.number);
}
