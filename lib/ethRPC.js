...
EthRPC.prototype.eth_peerCount = function(params, cb) {
  cb(null, this.app.network.peers.length);
};
...
EthRPC.prototype.eth_transact = function(params, cb) {
  var transaction = new Transaction(params[0]);
  var self = this;

  this.app.vm.runTx(transaction, function(err) {
    if (!err) {
...
function fnForMethod(method) {
  var map = {
    ...
    eth_transact: EthRPC.prototype.eth_transact,
