...
const EthRPC = require('./ethRPC.js');
const XhrRpc = require('./xhrRPC.js');
const WsRpc = require('./wsRPC.js');
const blockProcesser = require('./blockProcesser.js');
// const AccountMan = require('./accountManager');
const genesisAllotments = require('./genesisAllotments.json');
...
var App = module.exports = function(settings) {
  ...
  this.blockProcesser = new BlockProcesser(this);
...
App.prototype.start = function(cb) {
  ...
  if (this.settings.rpc) {
    tasks.startXhrRpcServer = ['setup', startXhrRpcServer];
    tasks.startWsRpcServer = ['setup', startWsRpcServer];
  }
